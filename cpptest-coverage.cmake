...
if(MSVC)
  set(CPPTEST_RUNTIME_SHARED ON)
  set(CPPTEST_RUNTIME_STATIC OFF) 
else()
  set(CPPTEST_RUNTIME_SHARED OFF)
  set(CPPTEST_RUNTIME_STATIC ON)
endif()
...
function (cpptest_enable_coverage)
  ...
  execute_process(COMMAND ${CMAKE_COMMAND}
                          ...
                          "-DCPPTEST_RUNTIME_SHARED=${CPPTEST_RUNTIME_SHARED}"
                          "-DCPPTEST_RUNTIME_STATIC=${CPPTEST_RUNTIME_STATIC}"
                  WORKING_DIRECTORY
                          ${CPPTEST_RUNTIME_BUILD_DIR})
  execute_process(COMMAND ${CMAKE_COMMAND}
                          --build .
  ...
  # Compute coverage data files (.cov) into ${CPPTEST_SOURCE_DIR}/.coverage/lastrun
